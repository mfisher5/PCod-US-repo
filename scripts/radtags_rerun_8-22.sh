...
# lane 1
process_radtags -p /media/mfisher5/New\ Volume/Kristen/Data/KOD03 -i gzfastq -y fastq -o /media/mfisher5/New\ Volume/Mary/Stacks/PCod-US-repo/samplesT92 -b barcodesL1.txt -e sbfI -E phred33 -r -c -q -t 92 

# lane 2
process_radtags -p /media/mfisher5/New\ Volume/Kristen/Data/AD06 -i gzfastq -y fastq -o /media/mfisher5/New\ Volume/Mary/Stacks/PCod-US-repo/samplesT92 -b barcodesL2_AD.txt -e sbfI -E phred33 -r -c -q -t 92 
