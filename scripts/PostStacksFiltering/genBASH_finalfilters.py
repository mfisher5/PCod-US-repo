...
shell.write("python " + convertDIRECT + "/Genepop_conversion_corrected.py " + stacksDIRECT + "/batch_" + BATCH + ".CorrectedGenotypes_biallelic.txt " + stacksDIRECT + "/batch_" + BATCH + ".CorrectedGenos_biallelic.genepop\n\n")
