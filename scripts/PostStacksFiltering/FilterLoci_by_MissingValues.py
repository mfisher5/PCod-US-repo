...
#next pop
		Count_MissingGenotypesByLocus_SokMuk = float(SokMuk.count('0000'))
		NumberOf_SokMuk_individuals = float(len(SokMuk))
		Percent_MissingData_SokMuk = float(Count_MissingGenotypesByLocus_SokMuk/NumberOf_SokMuk_individuals)
		overall_percent_missingdata.append(Percent_MissingData_SokMuk)
