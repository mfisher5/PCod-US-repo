...
genotype_file=open('/mnt/hgfs/Pacific cod/DataAnalysis/L1L2stacks_m10_boundSNP/batch_3.CorrectedGenos_biallelic.txt' ,'w')
...
Catalog_file=open('/mnt/hgfs/Pacific cod/DataAnalysis/L1L2stacks_m10_boundSNP/batch_3.biallelic_catalog.tsv','r')
...
list_of_indiv=open('/mnt/hgfs/Pacific cod/DataAnalysis/scripts/CorrectedGenos_Individs.txt','r')
for indiv in list_of_indiv:						## For each string in the file
	...
	matches_file=open('/mnt/hgfs/Pacific cod/DataAnalysis/L1L2stacks_m10_boundSNP/'+ indiv_name +'.matches.tsv','r')	# Open the matches.tags file for each individual in indiv_name list
...
#	print ind_loc_vs_cat
	...
	Indiv_file=open('/mnt/hgfs/Pacific cod/DataAnalysis/L1L2stacks_m10_boundSNP/'+ indiv_name +'.tags.tsv','r')	
